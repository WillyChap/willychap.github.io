...
# Git and Github Stuff {background-color="#2F2F2F"}
...
**Will**: Tu 11:15-12:15p  Aerospace Cafe
...
::: {.column width="50%"}
::: {.tiny}
![](./NovoAmor_AlbumArt.png)
:::
:::
::::

## ATOC 4815/5815 Midterm Playlist

:::: {.columns}
::: {.column width="50%"}
::: {.tiny}

**Spotify Playlist: Midterm01_ATOC4815**

- here → [playlist](https://open.spotify.com/playlist/3Swq0XY7cCIEK3f5A8HtXN?si=MAFcLCqETwWhPECAqaB0qg)
...
## I was pretty paranoid of git {.smaller}
...
cd ..
rm -rf atoc4815_git
git clone https://github.com/YOUR_USERNAME/atoc4815_git.git
```
...
::: {.fragment}
**What this looks like:** A browser tab opens asking you to sign in to GitHub. You'll see a page titled "Authorize Visual Studio Code." Click the green **Authorize** button. The browser will say "You can close this tab"
:::
...
::: {.fragment}
**Use whichever you prefer!** Terminal commands and the Source Control panel do the same thing. I use terminal commands because they work everywhere (servers, other editors, etc.).
:::
...
::: {.incremental}
1. Go to [github.com/WillyChap/atoc4815_git](https://github.com/WillyChap/atoc4815_git)
2. Click the **Fork** button (top right)
3. Click **Create fork**
4. You now have your own copy at `github.com/YOUR_USERNAME/atoc4815_git`
:::
...
- Git created a new folder called `atoc4815_git`
...
::: {.incremental}
1. Go to [github.com/WillyChap/atoc4815_git](https://github.com/WillyChap/atoc4815_git) and click **Fork**
2. Open your terminal (VS Code: `` Ctrl+` ``)
3. Navigate to where you want the project: `cd ~/ATOC4815`
4. Clone **your fork**: `git clone https://github.com/YOUR_USERNAME/atoc4815_git.git`
5. Run: `cd atoc4815_git`
...
Run it **all the time**. Before you do anything. After you do anything.
...
STUDENT_NAME = "Catherine Earnshaw"  # <-- put YOUR name
```
...
## Reading `git status` -- Translation Table {.smallest}
...
::: {.fragment}
**Don't memorize this.** Just run `git status` and read the output. Git tells you what to do!
:::
...
**Translation:** "Everything is saved."
:::
...
## Mantra: Status-Add-Commit-Status (SACS) {.smallest}
...
Just run `git status` and you'll see the file is still unstaged.
:::
...
`github.com/YOUR_USERNAME/atoc4815_git`
...
::: {.fragment}
**Check your history:** `git log --oneline` — you should see 3 new commits, each describing one function.
:::
...
2. Check the [practice repo README](https://github.com/WillyChap/atoc4815_git) for the cheat sheet
3. Ask a classmate
...
## Lab Assignment: {.smaller .scrollable}
