...
::: {.fragment}
**This is a methods class that will change how you do science.**
:::

::: {.fragment}
By the end of this semester:

- You'll analyze real climate data (ERA5, CMIP6, satellite obs)
- You'll create publication-quality figures
- You'll build reproducible research workflows
- You'll be prepared for graduate research or data science careers
:::
...
![PLACEHOLDER: Professional photo of Will](/images/william_chapman_square.jpg){width=200}
...
**PLACEHOLDER: Photo of Aiden**
<!-- Add Aiden's photo here -->
...
::: {.fragment}
**Grab a marker and add your info!** (We'll give you 5 minutes)
:::
...
**Real talk: This class is hard work.**

But here's what former students are doing now:

::: {.incremental}
- **Graduate school:** Using Python to analyze thesis data
- **NOAA:** Writing code to process satellite observations
- **NCAR:** Contributing to climate model development
- **Environmental consulting:** Automating data analysis workflows
- **Tech companies:** Data science and ML engineering
- **Academia:** Publishing reproducible research
:::
