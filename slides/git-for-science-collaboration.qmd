...
# Review & New Commands {background-color="#9CA898"}
...
## Using Your History: Rewinding {.smaller}
...
## Undoing a Bad Commit: `git revert` {.smallest}
...
# Branches: Parallel Code Bases {background-color="#2F2F2F"}
...
# Merge Conflicts: {background-color="#2F2F2F"}
...
6. When you're satisfied, click **Review changes** → **Approve**
:::
...
## Rules of Git Collaboration {.smaller}
...
## Lab Step 0: Pick a Shared Repo {.smaller}
...
git pull
```
3. Verify `collaborative_analysis.py` exists: `ls`
:::
