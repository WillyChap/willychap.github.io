...
## The Disaster, Visualized {.smaller}
...
## The Merge in a Diagram {.smaller}
...
## Practice Checkpoint: Create & Resolve a Conflict {.smaller}
...
2. Click on the PR
3. Click the **Files changed** tab to see what they modified
...
%%| fig-width: 10
flowchart LR
    A[1. Pull latest main] --> B[2. Create branch]
    B --> C[3. Make changes]
    C --> D[4. Add & Commit]
    D --> E{More changes?}
    E -->|Yes| C
    E -->|No| F[5. Push branch]
    F --> G[6. Create PR]
    G --> H[7. Partner reviews]
    H --> I[8. Merge PR]
    I --> J[9. Pull main]
```
...
## Lab Step 6: Review & Merge {.smaller}
