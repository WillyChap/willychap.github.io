...
1. Calculate wind chill: `WC = 13.12 + 0.6215*T - 11.37*V^0.16 + 0.3965*T*V^0.16`
   (T = temp in °C, V = wind speed in km/h)
...
## Matplotlib Overview {.tiny .scrollable}
...
## Common Error: Missing Legend Labels {.tiny}
