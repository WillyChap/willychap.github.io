...
Value does not depend on the size of the region.
...
**→ Interpolation is fine.** The temperature at a location doesn't change because you drew your grid cell differently.
:::
::: {.column width="50%"}
**Extensive variables**
*"amount in a region"*

Value *does* depend on area — it represents a total quantity accumulated over the cell.

- Precipitation accumulation
- Evaporation total
- Radiative energy flux (integrated)
- Cloud water path

**→ Interpolation is wrong.** If you bilinearly interpolate daily rainfall accumulation to a coarser grid, you change the total amount of rain in your domain.
:::
:::
