...
- [Final Project Clinic](/slides/atoc4815-final-project-guide.html)
- [Quick Start with Quarto Presentations](/slides/atoc4815-quarto-quickstart.html) - Install, first .qmd file, quarto render, edit→render→view loop, incremental bullets - Minimum viable package, geowind-era5 walkthrough, 8-step checklist, TestPyPI upload, CLI stretch goal, and PR contribution
